...
def render_sidebar():
    ...
    with st.sidebar:
        ...
        <div class="presence-bar">
            ...
            <a href="https://www.kaggle.com/kylekillebrew16" target="_blank" class="presence-icon" title="Kaggle">
        ...
        st.markdown("""
            <div class="sidebar-footer">
                ...
                Code, models, and resume self authored.<br>
                Disclaimer: The figures and analysis presented here<br>
                are allongoing and may contain errors.<br>
